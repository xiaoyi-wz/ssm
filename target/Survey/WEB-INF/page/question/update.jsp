...
<div class="layuimini-container">
    <div class="layuimini-main">
        ...
        <form class="layui-form" action="" lay-filter="demo">
            <input type="hidden" value="${question.id}" name="id"  lay-verify="required" autocomplete="off"class="layui-input">
...
<script>
    layui.use(['form','jquery','layer','laydate'], function () {
        ...
        //表单初始赋值
        form.val('demo', {
            "title": "${question.title}" // "name": "value"
            , "type": "${question.type}"
            , "required": "${question.required}"
            , "checkStyle": "${question.checkStyle}"
            , "orderStyle": "${question.orderStyle}"
