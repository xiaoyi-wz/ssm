    ...
    <div class="layuimini-main">
        ...
        <form class="layui-form" action=""  >
            ...
            <div class="layui-form-item" >
                ...
                <button type="button" class="layui-btn" style="width: auto"><input type="file" name="logo"  id="logo" />
                </button>
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="checkbox" checked="0" name="anon" lay-skin="switch" lay-filter="switchTest" lay-text="ON|OFF" value="0">
                </div>
            </div>
            <div class="layui-form-item">
                <div class="layui-input-block">
...
//goodInfo 里面即为想要传到后端的json数据
            formData.append('survey', new Blob([JSON.stringify(data.field)],{type: "application/json"}));
